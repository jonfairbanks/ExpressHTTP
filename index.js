...
if (!process.env.SESSION_SECRET) {
  console.warn('SESSION_SECRET not passed. Using a default value.\n')
...
app.use(
  '/',
  express.static(path.join(__dirname, process.env.SITE_ROOT || 'public'))
) // Use the ENV defined site root or default "public"
